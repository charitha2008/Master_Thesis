% Code to extract features using ResNet50 from Benign images

% Specify the folder to extarct the features from
imds=imageDatastore('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_Benign/');
