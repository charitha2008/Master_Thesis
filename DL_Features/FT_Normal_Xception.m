% Code to extract features using Xception from Normal images

% Specify the folder to extarct the features from
imds=imageDatastore('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_PM_Normal/');
