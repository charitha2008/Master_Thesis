...
% another folder
% Loaction to the Benign image folder
location_Normal = '/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/New_Images/Benign/*.png';       %  folder in which your images exists
...
for i = 1:length(ds_Normal.Files)
    ...
    imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_PM_Benign/', num2str(fileName3), '.png'), 'png');
%     imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_Benign/', num2str(fileName3), '.png'), 'png');
%     imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_PM_Benign/', num2str(fileName3), '.png'), 'png');
