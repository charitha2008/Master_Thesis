...
% another folder
% Loaction to the Cancer image folder
location_Normal = '/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/New_Images/Cancer/*.png';       %  folder in which your images exists
...
for i = 1:length(ds_Normal.Files)
    ...
    imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_PM_Cancer/', num2str(fileName3), '.png'), 'png');
    %     imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_Cancer/', num2str(fileName3), '.png'), 'png');
    %     imwrite(Segmented , strcat('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_PM_Cancer/', num2str(fileName3), '.png'), 'png');
