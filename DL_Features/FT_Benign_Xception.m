% Code to extract features using Xception from Cancer images

% Specify the folder to extarct the features from
imds=imageDatastore('/Users/dilukshidissanayake/Desktop/Thesis/Code/DDSM_Mini/SegImages_BR_PM_Benign/');

net = xception;
inputSize = net.Layers(1).InputSize;
% analyzeNetwork(net)
augimds = augmentedImageDatastore(inputSize(1:2),imds,'ColorPreprocessing','gray2rgb');
layer = 'predictions';%activation layer
...
% datastore
T_N = readtable('List_Benign.xlsx');%Data file with Age
